...
NOTES:
- modfiy in-place, no new memory allocation for a new array

APPROACH:
- guard: if array is 1 element or less, return it

- define a pointer set to 0
- while counter is less than length of array
    - compare current element to next element
    - if the same, splice out current element (keep same pointer)
    - if different, increment our pointer
- return input array
*/
